...
export default function AnalisarTexto() {
  ...
  async function analisarConteudo() {
    ...
    try {
      ...
      console.error("Erro ao salvar análise de texto:", error);
    }
  }

  const isDisabled = !conteudo.trim();
        ...
        >
          <View style={styles.content}>
            ...
            <Text style={styles.subtitle}>
              Digite ou cole o conteúdo para a análise ser realizada
            </Text>

            <TextInput
              style={styles.textArea}
              placeholder={
                "ex: Noticia da cidade X na data xx/xx/xxxx. Encontrada no site ..."
              }
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.85}
            >
              <Text style={styles.buttonText}>Analisar o Conteúdo</Text>
